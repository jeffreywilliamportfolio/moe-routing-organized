# Mirror Experiment Prompt Reference

Retained prompt scope:
This file preserves the prompt texts used for the 2026-04-01 mirror experiment. It is a prompt reference only; the corresponding per-cell capture payloads are not stored in this bundle.
