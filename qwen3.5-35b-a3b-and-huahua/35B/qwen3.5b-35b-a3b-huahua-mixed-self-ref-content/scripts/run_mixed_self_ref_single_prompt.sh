...
ROOT_DIR="${ROOT_DIR:-/workspace/consciousness-experiment/experiments/qwen3.5b-35b-a3b-huahua-mixed-self-ref-content}"
...
PROMPT_TSV="${PROMPT_TSV:-$ROOT_DIR/prompts/mixed_self_ref_single_prompt_no_think.tsv}"
LLAMA_BUILD_BIN="${LLAMA_BUILD_BIN:-/workspace/llama.cpp.new/build/bin}"

RUN_LABEL="${RUN_LABEL:-mixed_self_ref_single_prompt}"
