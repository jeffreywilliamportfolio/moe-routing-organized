...
ROOT_DIR="${ROOT_DIR:-/workspace/consciousness-experiment/experiments/qwen-huahua-expert-identification}"
...
PROMPT_JSON="${PROMPT_JSON:-$ROOT_DIR/prompts/domain_specialist_probe_60.json}"
PROMPT_TSV="${PROMPT_TSV:-$ROOT_DIR/prompts/domain_specialist_probe_60_no_think.tsv}"
PROMPT_BUILDER="${PROMPT_BUILDER:-$ROOT_DIR/scripts/build_domain_specialist_probe_60.py}"
...
RUN_LABEL="${RUN_LABEL:-domain_specialist_probe_60_no_think_hauhau}"
RAW_DIR="${RAW_DIR:-$ROOT_DIR/raw}"
RESULTS_DIR="${RESULTS_DIR:-$ROOT_DIR/results}"
N_PREDICT="${N_PREDICT:-2056}"
NGL="${NGL:-999}"
CTX="${CTX:-16384}"
THREADS="${THREADS:-16}"
...
meta = {
    ...
    "prompt_json_sha256": sha256_file("$PROMPT_JSON"),
