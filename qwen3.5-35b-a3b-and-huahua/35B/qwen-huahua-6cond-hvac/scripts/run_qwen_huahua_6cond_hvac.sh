...
ROOT_DIR="${ROOT_DIR:-/workspace/consciousness-experiment/experiments/qwen-huahua-6cond-hvac}"
...
PROMPT_TSV="${PROMPT_TSV:-$ROOT_DIR/prompts/prompts_qwen35b_6cond_l1l3_no_think_runtime_hvac_cal_water_treatment.tsv}"
PROMPT_BUILDER="${PROMPT_BUILDER:-$ROOT_DIR/scripts/build_qwen35b_6cond_l1l3_water_treatment_hvac_cal.py}"
...
RUN_LABEL="${RUN_LABEL:-qwen_huahua_6cond_hvac}"
