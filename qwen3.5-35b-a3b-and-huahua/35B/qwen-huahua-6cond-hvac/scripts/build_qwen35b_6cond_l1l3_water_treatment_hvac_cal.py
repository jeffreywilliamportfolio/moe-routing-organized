#!/usr/bin/env python3
"""Build the 180-row 6-condition L1/L2/L3 runtime TSV for the HVAC-cal /
...
# ---------------------------------------------------------------------------
# Output path: experiments/qwen-huahua-6cond-hvac/prompts/<file>
# Resolved relative to this script so the builder runs from any cwd.
# ---------------------------------------------------------------------------
EXPERIMENT_ROOT = Path(__file__).resolve().parent.parent
OUT = EXPERIMENT_ROOT / "prompts" / "prompts_qwen35b_6cond_l1l3_no_think_runtime_hvac_cal_water_treatment.tsv"
...
def default_out(thinking: bool) -> Path:
    if thinking:
        return EXPERIMENT_ROOT / "prompts" / "prompts_qwen35b_6cond_l1l3_think_runtime_hvac_cal_water_treatment.tsv"
    return OUT


def build_prompt(calibration: str, manipulation: str, thinking: bool) -> str:
    return f"{CHAT_PREFIX}{calibration} {manipulation} {calibration}{chat_suffix(thinking)}"
