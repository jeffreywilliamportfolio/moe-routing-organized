...
This file is the canonical results surface for the completed 122B 5-condition diectic baseline only.
Later 122B runs live under `followups/` and should not be read back into this baseline report.
