...
REMOTE_EXPERIMENT_DIR="${REMOTE_EXPERIMENT_DIR:-/workspace/consciousness-experiment/experiments/qwen3.5-122B-A10B-huahua-baseline/followups/single-prompt-processing-hum}"
